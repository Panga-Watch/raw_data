...
master_df <- read_csv("master_survey_resp_copy.csv")
...
```{r}
intro_df<- survey %>%
  mutate(interviewer_org = NA) %>% 
  select(start,	end,	survey_type,	survey_id,	survey_version,	interviewer, interviewer_org,	country,	community, sex) 
